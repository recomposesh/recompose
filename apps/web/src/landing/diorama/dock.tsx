...
export function Dock() {
  return (
    <div className="absolute inset-s-1/2 bottom-3 -translate-x-1/2">
      <div className="flex items-start gap-3 rounded-2xl border border-white/20 bg-white/30 px-3 pt-1.5 pb-1 backdrop-blur-md dark:border-white/10 dark:bg-white/10">
        {DOCK_APPS.map((app) => (
