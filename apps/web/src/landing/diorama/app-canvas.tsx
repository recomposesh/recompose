...
const WIRES = [
  { d: 'M208 164 C244 164, 244 92, 280 92', live: false },
  { d: 'M208 164 C244 164, 244 332, 280 332', live: true },
  { d: 'M464 92 L536 92', live: false },
  { d: 'M464 332 L536 332', live: true },
  { d: 'M720 332 C745 332, 745 172, 770 172', live: true },
  { d: 'M720 332 C745 332, 745 372, 770 372', live: false },
];
      ...
      <svg aria-hidden="true" viewBox="0 0 1000 592" className="absolute inset-0 size-full">
        {WIRES.map((wire) => (
          <path
            ...
            fill="none"
            strokeWidth={2.6}
            className={wire.live ? 'stroke-live' : 'stroke-cable'}
          />
        ))}
      </svg>
