import { PhosphorMark } from './phosphor-mark';
...
export function WindowsMark({ className = 'size-4' }: { className?: string }) {
  return <PhosphorMark d={fourPanes} className={className} />;
}
