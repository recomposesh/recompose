  ...
  return (
    <div className="flex items-center justify-between py-4">
      ...
      <a
        ...
        className="inline-flex items-center gap-1.75 rounded-full border border-stage-ring py-2 ps-4 pe-3.5 text-control font-medium text-fd-foreground transition-colors hover:bg-fd-accent"
      >
        download
