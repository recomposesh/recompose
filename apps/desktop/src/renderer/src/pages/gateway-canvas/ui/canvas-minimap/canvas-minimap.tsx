 ...
 * viewport left behind. The map's own component draws nodes alone, so the cables portal into its
 * svg in flow coordinates, and their stroke refuses the viewBox scaling to stay one hairline at
 * any zoom. Dragging the map moves the viewport it pictures, and a scroll over it zooms, so the
 * corner is a handle on the composition rather than only a picture of it.
 */
