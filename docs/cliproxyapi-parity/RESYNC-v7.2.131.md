...
| `internal/cache`                                    |    2 | `cache.md`                                                    | no         |
| `sdk/translator`                                    |    1 | `translator-common.md`                                        | no         |
| `internal/translator/openai/gemini`                 |    1 | the matching `translator-*.md`                                | no         |
| `internal/translator/gemini/gemini`                 |    1 | the matching `translator-*.md`                                | no         |
...
| `internal/translator/codex/gemini`                  |    1 | the matching `translator-*.md`                                | no         |
| `internal/translator/claude/gemini`                 |    1 | the matching `translator-*.md`                                | no         |
| `internal/translator/antigravity/gemini`            |    1 | the matching `translator-*.md`                                | no         |
