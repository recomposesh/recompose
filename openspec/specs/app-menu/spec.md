...
The behavioral contract of the application menu bar, the macOS Dock menu, and the keyboard
accelerators they print. It covers the bar's platform shape, the Help menu, View's navigation
and surface toggles, and the Gateway menu's lifecycle and zoom groups. It also pins what a
packaged build does with the keystrokes the menus advertise.
